        ...
        {projects.map((projects, index) => (
          <Col sm='12' md='12' lg='6'>
            <Card className='mb-4' key={index}>
              ...
              <Card.Body>
                <Card.Link href="#"><img src={chain} class='project-icons' alt="" /></Card.Link>
                <Card.Link href="#"><img src={github} class='project-icons' alt="" /></Card.Link>
                <Card.Link href="#"><img src={readme} class='project-icons' alt="" /></Card.Link>
              </Card.Body>
            </Card>
          </Col>
        ))}
